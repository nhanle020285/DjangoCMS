...
function fadingElements() {
    //Elements Fading
    $('#placeHolderContent .element_from_top').each(function () {
        $(this).appear(function () {
            $(this).delay(150).animate({ opacity: 1, top: "0px" }, 1000);
        });
    });

    $('#placeHolderContent .element_from_bottom').each(function () {
        $(this).appear(function () {
    ...
    $('#placeHolderContent .element_from_left').each(function () {
        $(this).appear(function () {
    ...
    $('#placeHolderContent .element_from_right').each(function () {
        $(this).appear(function () {
            $(this).delay(150).animate({ opacity: 1, right: "0px" }, 1000);
        });
    });

    $('#placeHolderContent .element_fade_in').each(function () {
        $(this).appear(function () {
            $(this).delay(150).animate({ opacity: 1, right: "0px" }, 1000);
        });
    });
    ...
    $('#placeHolderContent .bar li').each(function () {
        $(this).appear(function () {
    ...
    //Animated Counters
    $('#placeHolderContent .counters').each(function () {
    ...
    //Fading Out AlertBox
    $('#placeHolderContent .shortcode_alertbox').find('.box_close').click(function () {
